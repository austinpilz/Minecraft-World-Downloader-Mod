package com.pilzbros.archiver.hud;
...
public class HudExample extends HudElement {
     ...
     */
    public static final HudElementInfo<HudExample> INFO = new HudElementInfo<>(ArchiverAddon.HUD_GROUP, "example", "HUD element example.", HudExample::new);
